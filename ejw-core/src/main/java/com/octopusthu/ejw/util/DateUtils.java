...
public class DateUtils {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("比较日期 － diffDays():" + DateUtils.diffDays(DateUtils.getNow(), date));
			System.out.println("比较月份 － diffMonths():" + DateUtils.diffMonths(DateUtils.getNow(), date));

			System.out.println("得到" + test + "所在月份的最后一天:" + getDateTime(getMonthLastDay(date), "yyyy-MM-dd"));
			System.out.println(("" + DateUtils.getCurrentYear()).substring(2) + "000001");
